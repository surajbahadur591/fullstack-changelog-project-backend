...
CREATE TABLE "UpdatPoints" (
    ...
    CONSTRAINT "UpdatPoints_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "UpdatPoints" ADD CONSTRAINT "UpdatPoints_updateId_fkey" FOREIGN KEY ("updateId") REFERENCES "Update"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
